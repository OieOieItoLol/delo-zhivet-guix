...
@Component
class EcologicalProblemPhotosInputIntermediateProcessor(private val botContext: BotContext) : IntermediateProcessor {
    ...
    override fun invoke(update: Update) {
        ...
        userContext.ecologicalProblem = userContext.ecologicalProblem.copy(photo = photoByteArray)
    }
